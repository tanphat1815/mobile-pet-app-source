      ...
      <Card style={styles.section}>
        <View style={styles.chatLinkRow}>
          <View style={{ flex: 1 }}>
            ...
            >
              5 địa điểm · Kho báu · Sinh vật hoang dã
            </Text>
          </View>
          <Button
            title="Open"
            onPress={() => navigation.navigate('AdventureHome')}
            variant="primary"
            size="sm"
            testID="home-adventure-open"
          />
        </View>
      </Card>

      {/* AI Chatbot quick-link */}
      <Card style={styles.section}>
        <View style={styles.chatLinkRow}>
          <View style={{ flex: 1 }}>
            <Text
            ...
            >
              7 nhà cung cấp · BYOK · Gemini · Claude · GPT · Local
            </Text>
          </View>
          <Button
            title="Open"
      ...
      <Card style={styles.section}>
        <View style={styles.chatLinkRow}>
          <View style={{ flex: 1 }}>
            ...
            >
              8 kỹ năng · Huấn luyện · Biểu diễn · Cooldown 15s
            </Text>
          </View>
          <Button
            title="Open"
            onPress={() => navigation.navigate('TricksHome')}
            variant="primary"
            size="sm"
            testID="home-tricks-open"
          />
        </View>
      </Card>

      {/* Step 12f — Competitions quick-link */}
      <Card style={styles.section}>
        <View style={styles.chatLinkRow}>
          <View style={{ flex: 1 }}>
            <Text
            ...
            >
              5 giải đấu · Đua điểm · Bracket · Daily & Weekly
            </Text>
          </View>
          <Button
            title="Open"
            onPress={() => navigation.navigate('CompetitionsHome')}
            variant="primary"
            size="sm"
            testID="home-competitions-open"
          />
        </View>
      </Card>
